...
CNSS_PREALLOC_DIR := CORE/CNSS_PREALLOC
CNSS_PREALLOC_INC_DIR :=	$(CNSS_PREALLOC_DIR)/inc
CNSS_PREALLOC_SRC_DIR :=	$(CNSS_PREALLOC_DIR)/src

CNSS_PREALLOC_INC := -I$(WLAN_ROOT)/$(CNSS_PREALLOC_INC_DIR)

CNSS_PREALLOC_OBJS := $(CNSS_PREALLOC_SRC_DIR)/cnss_prealloc.o
...
CDEFINES += -DCONFIG_WCNSS_MEM_PRE_ALLOC
endif
ifeq ($(CONFIG_WCNSS_SKB_PRE_ALLOC),y)
CDEFINES += -DCONFIG_WCNSS_SKB_PRE_ALLOC
